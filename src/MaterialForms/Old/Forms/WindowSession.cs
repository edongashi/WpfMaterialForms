...
namespace MaterialForms
{
    ...
    public class WindowSession : Session
    {
        ...
        /// <summary>
        ///     Gets whether the window has loaded and has been displayed to the user. A true value does not guarantee that the
        ...
        public Task<bool?> ShowDialog(MaterialDialog dialog)
        {
            return ShowDialog(dialog, double.NaN);
        }

        public Task<bool?> ShowDialog(MaterialDialog dialog, double dialogWidth)
        {
            return ShowDialogTracked(dialog, dialogWidth).Task;
        }

        public DialogSession ShowDialogTracked(MaterialDialog dialog)
        {
            return ShowDialogTracked(dialog, double.NaN);
        }
        ...
        public Task<bool?> Prompt(string message)
        {
            return Prompt(message, null);
        }

        public Task<bool?> Prompt(string message, string title)
        {
            return Prompt(message, title, "OK");
        }

        public Task<bool?> Prompt(string message, string title, string positiveAction)
        {
        ...
        {
            return await ShowDialog(new MaterialDialog(message, title, positiveAction, negativeAction), 275d);
        }
